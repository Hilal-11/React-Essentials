    ...
    <div className='w-full flex justify-between py-2 px-2 lg:px-28 ring-1'>
        ...
        <div className="flex justify-center items-center gap-2 lg:relative">
            ...
            <div className="flex gap-2">
                <button className="rounded-md px-2 py-2 text-blue-100 text-lg shadow-inner bg-slate-900 shadow-slate-800 hover:bg-blue-600 hover:shadow-2xl text-center"><AiOutlineUserAdd/></button>
